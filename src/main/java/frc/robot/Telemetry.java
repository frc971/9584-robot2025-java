...
public class Telemetry {
    private final Measure<edu.wpi.first.units.Velocity<edu.wpi.first.units.Distance>> MaxSpeed;
    ...
    public Telemetry(Measure<edu.wpi.first.units.Velocity<edu.wpi.first.units.Distance>> maxSpeed) {
        MaxSpeed = maxSpeed;
